...
namespace Microsoft.Azure.WebJobs.Script.Description
{
    ...
    public class BindingMetadata
    {
        ...
        public static BindingMetadata Create(JObject raw)
        {
            ...
            bool isProxy = false;
            if(raw["isProxy"] != null && !bool.TryParse((string)raw["isProxy"], out isProxy))
            {
                throw new FormatException(string.Format(CultureInfo.InvariantCulture, "'{0}' is not a valid boolean value.", (string)raw["isProxy"]));
            }
